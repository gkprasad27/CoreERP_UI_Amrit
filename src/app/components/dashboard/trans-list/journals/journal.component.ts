...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, NonEditableDatepicker, DynamicTableComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

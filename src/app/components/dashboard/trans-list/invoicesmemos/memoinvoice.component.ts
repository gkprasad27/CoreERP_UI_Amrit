...
@Component({
  ...
  imports: [ReactiveFormsModule, TranslatePipe, NgMultiSelectDropDownModule, TableComponent, TranslateModule, TypeaheadModule, NonEditableDatepicker, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule],
...
export class MemoinvoiceComponent implements OnInit {
  ...
  allApis() {
    ...
    import('rxjs').then(rxjs => {
      ...
      ]).subscribe(([materialRes, glList, taxratesList, ptypeList, bPList, hsnsacList]) => {
        this.spinner.hide();

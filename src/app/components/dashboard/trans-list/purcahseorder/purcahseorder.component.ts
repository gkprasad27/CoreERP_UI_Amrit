...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, NonEditableDatepicker, NgMultiSelectDropDownModule, TableComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

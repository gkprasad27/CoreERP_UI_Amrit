...
@Component({
  ...
  imports: [ReactiveFormsModule, TranslatePipe, TranslateModule, NonEditableDatepicker, NgMultiSelectDropDownModule, TypeaheadModule, TableComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule],

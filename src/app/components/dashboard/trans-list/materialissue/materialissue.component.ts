...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, NonEditableDatepicker, NgMultiSelectDropDownModule, TypeaheadModule, TableComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

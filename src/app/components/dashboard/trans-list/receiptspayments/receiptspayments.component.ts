...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, DynamicTableComponent, TypeaheadModule, NonEditableDatepicker, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

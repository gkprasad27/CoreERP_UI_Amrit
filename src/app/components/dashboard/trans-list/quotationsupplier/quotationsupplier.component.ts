...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, TableComponent, TypeaheadModule, NonEditableDatepicker, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

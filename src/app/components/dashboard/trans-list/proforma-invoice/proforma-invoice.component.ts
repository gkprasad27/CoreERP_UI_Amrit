...
export class ProformaInvoiceComponent implements OnInit {
        ...
        response => {
          ...
          if (!this.commonService.checkNullOrUndefined(res) && res.status === StatusCodes.pass) {
            if (!this.commonService.checkNullOrUndefined(res.response)) {
              ...
              const arr = [];
              res.response['saleordernoList'].forEach((i: any, index: number) => {
                const master = res.response['saleOrderMasterList'];
  ...
  savegoodsreceipt() {
    ...
    this.apiService.apiPostRequest(registerInvoice, requestObj).subscribe(
      response => {
        ...
        if (!this.commonService.checkNullOrUndefined(res) && res.status === StatusCodes.pass) {
          if (!this.commonService.checkNullOrUndefined(res.response)) {
            this.router.navigateByUrl('dashboard/transaction/proformainvoice');
  ...
  back() {
    this.router.navigate(['dashboard/transaction/proformainvoice'])
  }

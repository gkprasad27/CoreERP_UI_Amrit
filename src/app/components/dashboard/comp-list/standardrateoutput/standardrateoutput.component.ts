...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, TableComponent, TypeaheadModule, NgMultiSelectDropDownModule, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

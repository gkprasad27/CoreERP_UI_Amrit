...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, NgxMatTimepickerModule, TableComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

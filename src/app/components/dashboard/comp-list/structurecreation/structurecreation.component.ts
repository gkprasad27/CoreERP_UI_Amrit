...
@Component({
  ...
  imports: [ CommonModule, FormsModule, ReactiveFormsModule, TranslatePipe, MatPaginatorModule, MatTableModule, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

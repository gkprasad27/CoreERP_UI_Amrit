...
@Component({
  selector: 'app-dispatchstatus',
  imports: [ReactiveFormsModule, TranslatePipe, TranslateModule, NgMultiSelectDropDownModule, FileUploadComponent, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule],
  templateUrl: './dispatchstatus.component.html',
  styleUrls: ['./dispatchstatus.component.scss'],
  providers: [ DatePipe ]
})
export class DispatchstatusComponent {
  ...
  constructor(public commonService: CommonService,
    ...
    public dialogRef: MatDialogRef<DispatchstatusComponent>,

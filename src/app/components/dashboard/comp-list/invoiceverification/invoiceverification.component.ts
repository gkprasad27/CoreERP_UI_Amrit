...
@Component({
  ...
  imports: [ CommonModule, ReactiveFormsModule, TranslatePipe, NonEditableDatepicker, DynamicTableComponent, MatNativeDateModule, MatFormFieldModule, MatCardModule, MatTabsModule, MatDividerModule, MatSelectModule, MatDatepickerModule, MatInputModule, MatButtonModule, MatIconModule ],

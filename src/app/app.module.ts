...
import {
  ...
  HolidayComponent,SalaryProcessComponent, QuorantineComponent, CAPAdetailsComponent
...
@NgModule({
  declarations: [
    ...
    PoHistoryComponent,
    HolidayComponent,
    DispatchdetailsComponent,SalaryProcessComponent, QuorantineComponent, CAPAdetailsComponent, ReportsComponent
  ],
  imports: [
    AppRoutingModule,
    SharedImportModule,
  ...
  entryComponents: [
    ...
    DesignationComponent,
    SalesorderComponent,StructureCreationComponent, SalesInvoiceComponent, HolidayComponent,SalaryProcessComponent
  ]
})
